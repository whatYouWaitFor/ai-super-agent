...
public class ToolCallAgent extends ReActAgent{
    ...
    public String act() {
        ...
        // 调用工具
        Prompt prompt = new Prompt(getSystemPrompt(), this.chatOptions);
        ToolExecutionResult toolExecutionResult = toolCallingManager.executeToolCalls(prompt, toolCallResponse);
        // 记录消息上下文，conversationHistory() 方法会返回一个包含助手消息和工具调用结果的列表
